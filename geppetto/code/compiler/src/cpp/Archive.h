...
public:
  ...
  void write_elt_array(Encoding* encoding, EncodedEltArray* arr, bool simple=false);
  void read_elt_array(Encoding* encoding, EncodedEltArray** arr);

	Archiver* get_archiver() { return arc; }
